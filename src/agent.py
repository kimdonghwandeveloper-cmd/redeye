...
projected_score: Start with current_score. Add points back for each vulnerability that has a valid fix generated by `generate_fix`.
Example: current_score 60 + 20 (Fix 1) + 20 (Fix 2) = 100. Max 100.
"""),
    ("user", "{input}"),
